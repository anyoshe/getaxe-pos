...
class BranchesService {
  ...
  async getBranch(
    ...
    const branch = await branchesRepository.findById(
      id,
      businessId
    );
  ...
  async createBranch(data: CreateBranchInput) {
    const exists = await branchesRepository.exists(
      data.code,
      data.businessId
    );
  ...
  async updateBranch(
    ...
    if (
      ...
      const exists =
        await branchesRepository.exists(
          data.code,
          businessId
        );
    ...
    return branchesRepository.update(
      id,
      businessId,
      data
    );
  ...
  async deleteBranch(
    ...
    return branchesRepository.delete(
      id,
      businessId
    );
  }
