...
export class InventoryService {
    ...
    async receiveStock(
        ...
        return Repository.withTransaction(
            async (tx) => {
                ...
                return this.receiveStockWithUnitOfWork(
                    uow,
                    request
                );
    ...
    async issueStock(
        ...
        return Repository.withTransaction(
            async (tx) => {
                ...
                return this.issueStockWithUnitOfWork(
                    uow,
                    request
                );
    ...
    async adjustStock(
        ...
        inventoryValidator.validateAdjustment(
            request
        );
        ...
        return Repository.withTransaction(
            async (tx) => {
                ...
                return this.adjustStockWithUnitOfWork(
                    uow,
                    request
                );
    ...
    async transferStock(
        ...
        inventoryValidator.validateTransfer(
            request
        );
        ...
        return Repository.withTransaction(
            async (tx) => {
                ...
                return this.transferStockWithUnitOfWork(
                    uow,
                    request
                );
    ...
    async transferStockWithUnitOfWork(
        ...
        const outMovement =
            await uow.movements.create({
                ...
                reference:
                    request.movement.reference,

                notes:
                    request.movement.notes,

                userId:
                    request.movement.userId,
