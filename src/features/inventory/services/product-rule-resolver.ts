...
export const PRODUCT_CAPABILITY_RULES: Array<{
  ...
  { capability: "inventory.sku", productTypes: [...PRODUCT_TYPES] },
  { capability: "inventory.barcode", productTypes: [...PRODUCT_TYPES] },
  { capability: "inventory.brands", productTypes: [...PRODUCT_TYPES] },
  { capability: "inventory.cost-price", productTypes: [...PRODUCT_TYPES] },
  { capability: "inventory.negative-stock", productTypes: ["physical", "medicine", "raw-material", "finished-product"] },
  { capability: "inventory.manufacturers", productTypes: ["medicine", "physical", "raw-material", "finished-product"] },
  { capability: "finance.tax-rates", productTypes: [...PRODUCT_TYPES] },
...
export const PRODUCT_FIELD_DEFINITIONS: ProductFieldDefinition[] = [
  ...
  { key: "sku", label: "SKU", step: "product-information", productTypes: [...PRODUCT_TYPES], capability: "inventory.sku" },
  { key: "barcode", label: "Barcode", step: "product-information", productTypes: [...PRODUCT_TYPES], capability: "inventory.barcode" },
  { key: "productBrand", label: "Brand", step: "product-information", productTypes: [...PRODUCT_TYPES], capability: "inventory.brands" },
  { key: "costPrice", label: "Cost Price", step: "pricing", productTypes: [...PRODUCT_TYPES], capability: "inventory.cost-price" },
  ...
  { key: "allowNegativeStock", label: "Allow Negative Stock", step: "inventory", productTypes: ["physical", "medicine", "raw-material", "finished-product"], capability: "inventory.negative-stock" },
  ...
  { key: "isControlled", label: "Controlled medicine", step: "inventory", productTypes: ["medicine"], capability: "pharmacy.controlled-medicines" },
  ...
  { key: "manufacturerId", label: "Manufacturer", step: "classification", productTypes: ["medicine", "physical", "raw-material", "finished-product"], capability: "inventory.manufacturers" },
  { key: "supplierId", label: "Supplier", step: "classification", productTypes: [...PRODUCT_TYPES] },
  { key: "taxRateId", label: "Tax Rate", step: "accounting", productTypes: [...PRODUCT_TYPES], capability: "finance.tax-rates" },
