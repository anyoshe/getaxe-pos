...
export const productFormSchema = z.object({
  ...
  drugCategoryId: z.string().uuid().nullable(),

  dosageFormId: z.string().uuid().nullable(),

  drugStrengthId: z.string().uuid().nullable(),

  prescriptionTypeId: z.string().uuid().nullable(),

  purchaseUnitId: z.string().uuid().nullable(),

  salesUnitId: z.string().uuid().nullable(),

  stockUnitId: z.string().uuid().nullable(),

  incomeAccountId: z.string().uuid().nullable(),
...
export interface ProductLookupData {
  ...
  drugCategories: SelectOption[];

  dosageForms: SelectOption[];

  drugStrengths: SelectOption[];

  prescriptionTypes: SelectOption[];

  taxRates: SelectOption[];

  incomeAccounts: SelectOption[];

  expenseAccounts: SelectOption[];

  inventoryAccounts: SelectOption[];
}
