...
export const AUDIT_COMPLIANCE_CAPABILITIES: CapabilityDefinition[] = [
  {
    ...
    code: "AUDIT_REPORTS",
    name: "Audit Reports",
    description: "Generate audit reports for business activities and transactions.",
    module: "REPORTING",
    group: "REPORTS",
    category: "REPORTING",
    status: "ACTIVE",
  ...
  },
  {
    ...
    description: "Monitor compliance requirements and business controls.",
    module: "REPORTING",
    group: "REPORTS",
    category: "REPORTING",
    status: "ACTIVE",
  ...
  },
  {
    ...
    description: "Generate reports on security events and access activities.",
    module: "REPORTING",
    group: "REPORTS",
    category: "REPORTING",
    status: "ACTIVE",
  ...
  },
  {
    ...
    description: "Generate reports for regulatory and compliance obligations.",
    module: "REPORTING",
    group: "REPORTS",
    category: "REPORTING",
    status: "ACTIVE",
