...
export const PRESCRIPTION_CAPABILITIES: CapabilityDefinition[] = [
  {
    ...
    description: "Create and manage patient medicine prescriptions.",
    module: "PHARMACY",
    group: "PHARMACY",
    category: "PHARMACY",
    status: "ACTIVE",
  ...
  },
  {
    ...
    description: "Manage doctors and healthcare providers who issue prescriptions.",
    module: "PHARMACY",
    group: "CLINICAL",
    category: "CLINICAL",
    status: "ACTIVE",
  ...
  {
    id: "pharmacy.prescription-history",
    code: "PATIENT_PRESCRIPTION_HISTORY",
    name: "Prescription History",
    description: "Maintain patient prescription history.",
    module: "PHARMACY",
    group: "CLINICAL",
    category: "CLINICAL",
    status: "ACTIVE",
  ...
  },
  {
    ...
    description: "Control medicine refills based on prescription rules.",
    module: "PHARMACY",
    group: "PHARMACY",
    category: "PHARMACY",
    status: "ACTIVE",
