...
export const DRUG_CLASSIFICATION_CAPABILITIES: CapabilityDefinition[] = [
  {
    ...
    description: "Classify medicines by therapeutic category.",
    module: "PHARMACY",
    group: "PHARMACY",
    category: "PHARMACY",
    status: "ACTIVE",
  ...
  },
  {
    ...
    description: "Manage active pharmaceutical ingredients in medicines.",
    module: "PHARMACY",
    group: "PHARMACY",
    category: "PHARMACY",
    status: "ACTIVE",
  ...
  {
    id: "pharmacy.generic-brand-medicines",
    code: "GENERIC_BRAND_MANAGEMENT",
    name: "Generic and Brand Medicines",
    description: "Support generic medicines and branded equivalents.",
    module: "PHARMACY",
    group: "PHARMACY",
    category: "PHARMACY",
    status: "ACTIVE",
  ...
  },
  {
    ...
    description: "Manage medicines requiring special control and tracking.",
    module: "PHARMACY",
    group: "PHARMACY",
    category: "PHARMACY",
    status: "ACTIVE",
