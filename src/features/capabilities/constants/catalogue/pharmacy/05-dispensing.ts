...
export const DISPENSING_CAPABILITIES: CapabilityDefinition[] = [

  {
    ...
    description:
      "Dispense medicines against prescriptions and sales transactions.",
...

  {
    ...
    description:
      "Allow dispensing part of a prescribed quantity.",
...

  {
    ...
    description:
      "Require pharmacist approval before medicine dispensing.",
...

  {
    ...
    description:
      "Allow approved alternative medicine substitutions.",
